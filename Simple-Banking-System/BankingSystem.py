...
customerNames = ['Arnold Muller', 'Zena Muller', 'Zeelia Muller', 'Zeekia Muller', 'Kezia Muller']
customerPins = ['0123', '2575', '7275', '2312', '5049']
customerBalances = [100000, 20000, 20000, 40000, 10000]
deposition = 0
withdrawal = 0
balance = 0
counter_1 = 1
